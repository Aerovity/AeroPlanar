			...
			<CardContent className="space-y-6">
				...
				<Tabs value={activeTab} onValueChange={setActiveTab}>
					...
					>
						<div className="space-y-2">
							...
							<p className="text-xs text-gray-400">
								{textPrompt.length}/1024 characters • Be
								descriptive for better results
							</p>
						</div>
						<div className="space-y-2">
							<Label className="text-gray-300">
							...
							/>
							<p className="text-xs text-gray-400">
								{negativePrompt.length}/255 characters • What
					...
					<TabsContent value="multimodal" className="space-y-4 mt-4">
						...
						<div className="space-y-2">
							...
							/>
							<p className="text-xs text-gray-400">
								Describe modifications or enhancements to apply
				...
				{(selectedFile || textPrompt.trim()) && (
					<div className="p-3 bg-blue-600/10 border border-blue-500/30 rounded-lg">
						...
						{textPrompt.trim() && (
							<p className="text-sm text-blue-300 font-medium">
								Prompt: {textPrompt.slice(0, 50)}
								{textPrompt.length > 50 ? "..." : ""}
							</p>
						)}
						{negativePrompt.trim() && (
							<p className="text-sm text-blue-300 font-medium">
								Negative: {negativePrompt.slice(0, 30)}
						...
						<p className="text-xs text-blue-400 mt-1">
							{activeTab === "text-to-image"
								...
								: selectedFile?.name
										.toLowerCase()
										.match(
											/\.(glb|gltf|obj|fbx|dae|3ds|ply|stl)$/
										)
				...
				<div className="space-y-4">
					...
					<div className="space-y-4">
						<div>
							...
							>
								...
								<SelectContent className="bg-gray-900 border-gray-700">
									...
									<SelectItem value="v1.4-20240625">
										v1.4 (Stable)
									</SelectItem>
								</SelectContent>
							</Select>
						...
						<div>
							<Label className="text-gray-300">
								Texture Resolution: {options.textureResolution}
								px
							</Label>
							<Slider
