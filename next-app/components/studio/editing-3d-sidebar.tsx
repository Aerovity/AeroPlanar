...
export function Editing3DSidebar({ selectedModelId, onToolSelect, activeTool }: Editing3DSidebarProps) {
  ...
  return (
    <div className="space-y-4">
                  ...
                  <Button
                    ...
                    className={`w-full justify-center ${
                      activeTool === 'sculpt-push'
                        ...
                        : "[#080c0c]/20 border-gray-700 text-white hover:[#080c0c]/15"
                    }`}
      ...
      {!selectedModelId && (
        <Card className="[#080c0c]/20 border-amber-500/30 backdrop-blur-sm">
      ...
      {selectedModelId && (
        <>
                  ...
                  <Button
                    ...
                    className={`h-8 w-full p-1 ${
                      selectedTexture === texture.id
                        ...
                        : "[#080c0c]/20 border-gray-700 hover:[#080c0c]/15"
                    }`}
          ...
          {/* Active Tool Status */}
          {activeTool && (
            <Card className="[#080c0c]/20 border-green-500/30 backdrop-blur-sm">
