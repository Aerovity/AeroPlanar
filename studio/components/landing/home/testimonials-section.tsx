		...
		<section className="py-16 md:py-24">
			<div className="max-w-5xl mx-auto px-4 sm:px-6">
				...
				<a
					...
					className="block relative bg-white/5 border border-white/10 rounded-md p-8 md:p-12 lg:p-16 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 cursor-pointer group"
				>
					{/* Quote Icon */}
				...
				<div className="text-center mt-12 md:mt-16">
					...
					>
						YOYO empowers the rebellious, creative spirit of coding
						— where breakthrough innovations are born.
					</p>
				</div>
			</div>
		</section>
