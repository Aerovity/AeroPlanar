...
export function TransformGizmo({ position, onTransform, visible }: TransformGizmoProps) {
  ...
  const handlePointerMove = (e: any) => {
    ...
    switch (isDragging) {
      ...
      case "y":
        ...
        break
      case "z":
        onTransform([x, y, z + e.movementZ * sensitivity || e.movementX * sensitivity])
        break
    }
  }
  ...
  return (
    <group ref={gizmoRef} position={position} onPointerMove={handlePointerMove} onPointerUp={handlePointerUp}>
      {/* X Axis - Red */}
      <group>
        <mesh
          position={[1.5, 0, 0]}
        ...
        >
          ...
          <meshBasicMaterial color={hovered === "x" ? "#ff6b6b" : "#ff4444"} transparent opacity={0.8} />
        </mesh>
        <mesh position={[3, 0, 0]} onPointerDown={handlePointerDown("x")}>
      ...
      <group>
        ...
        >
          <cylinderGeometry args={[0.05, 0.05, 3, 8]} />
          <meshBasicMaterial color={hovered === "y" ? "#6bff6b" : "#44ff44"} transparent opacity={0.8} />
        </mesh>
        <mesh position={[0, 3, 0]} onPointerDown={handlePointerDown("y")}>
          <coneGeometry args={[0.15, 0.4, 8]} />
          <meshBasicMaterial color={hovered === "y" ? "#6bff6b" : "#44ff44"} transparent opacity={0.8} />
        </mesh>
      </group>
      ...
      <group>
        ...
        >
          <cylinderGeometry args={[0.05, 0.05, 3, 8]} />
          <meshBasicMaterial color={hovered === "z" ? "#6b6bff" : "#4444ff"} transparent opacity={0.8} />
        </mesh>
        <mesh position={[0, 0, 3]} rotation={[Math.PI / 2, 0, 0]} onPointerDown={handlePointerDown("z")}>
          <coneGeometry args={[0.15, 0.4, 8]} />
          <meshBasicMaterial color={hovered === "z" ? "#6b6bff" : "#4444ff"} transparent opacity={0.8} />
        </mesh>
      </group>
      ...
      <mesh onPointerDown={handlePointerDown("center")}>
        ...
        <meshBasicMaterial color={hovered === "center" ? "#ffffff" : "#cccccc"} transparent opacity={0.6} />
      </mesh>
