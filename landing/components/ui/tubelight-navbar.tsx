		...
		>
			...
			>
				...
				<div
					className={cn(
						"flex items-center transition-all duration-500",
						isScrolled ? "gap-1" : isMobile ? "gap-1" : "gap-4"
					)}
				>
					{navigationItems
						.slice(
							0,
							isMobile && !isScrolled ? 5 : navigationItems.length
						)
						.map((item) => {
												...
												<div
													className={cn(
														...
														isScrolled
															...
															: isMobile
															? "w-3 h-3 top-0 left-1.5"
															: "w-6 h-6 top-0 left-2"
													)}
													style={{
														backgroundColor:
															"#c3b383" + "33",
					...
					<div className="flex items-center gap-3">
						...
						>
							...
							<span className="md:hidden">
								<LogIn
									size={isMobile && !isScrolled ? 16 : 18}
									strokeWidth={2.5}
								/>
							</span>
						</Link>
