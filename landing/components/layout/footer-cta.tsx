...
export function FooterCTA() {
	...
	return (
		<div
			className="border border-border md:container text-center px-10 py-14 mx-4 md:mx-auto md:px-24 md:py-20 mb-32 mt-24 flex items-center flex-col rounded-3xl shadow-lg shadow-muted/20"
