			...
			<div className="border border-border lg:basis-2/3 bg-card rounded-md p-10 flex lg:space-x-8 lg:flex-row flex-col-reverse lg:items-start group">
				...
				<div className="flex flex-col basis-1/2 relative h-full">
					...
					<p className="text-[#878787] mb-4 text-sm">
						Transform your concepts with our advanced AI rendering
						capabilities.
					</p>

					<p className="text-[#878787] text-sm">
						Generate photorealistic renders, apply intelligent
						lighting, and create stunning visualizations from your
						3D models with just a few clicks.
					</p>
					...
					<div className="flex flex-col space-y-2 h-full">
						...
						<div className="absolute bottom-0 left-0">
							<CtaLink
								...
								className="text-[#c3b383] hover:text-[#c3b383]"
							/>
						</div>
					</div>
				</div>
