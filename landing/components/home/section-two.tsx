				...
				<div className="flex flex-col md:space-x-12 md:flex-row">
					...
					<div className="xl:mt-6 md:max-w-[40%] md:ml-8 md:mb-8">
						...
						<p className="text-muted-foreground md:mb-4 text-sm font-sans">
							Transform your creative workflow with our AI-powered
							3D studio. Generate stunning 3D models from 2D
							images, collaborate in real-time, and optimize your
							assets for peak performance across all platforms and
							devices.
						</p>
						...
						<div className="flex flex-col space-y-2">
							...
							<div className="flex space-x-2 items-center text-sm">
								...
								<span className="text-primary">
									Cross-platform asset delivery and
									optimization
								</span>
							</div>
						</div>
