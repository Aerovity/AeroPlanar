...
export default function VibeCodingTweetsSection({
	onOpenInstall,
}: VibeCodingTweetsSectionProps) {
	const [expandedTweets, setExpandedTweets] = useState<Set<number>>(
		new Set()
	);
		...
		<section className="py-16 md:py-24">
			<div className="max-w-6xl mx-auto px-4 sm:px-6">
				...
				<div className="text-center mb-6 md:mb-12 px-4">
					...
					>
						Don't take our word for it — this is what devs are
						actually saying.
					</p>
				</div>
				...
				<div className="flex justify-center">
					<div
						...
						style={{
							background:
								"linear-gradient(135deg, #22d3ee 0%, #ff5c28 50%, #ff5c9d 100%)",
						}}
					>
						{/* Dark Overlay */}
								...
								<div className="flex justify-center">
									<div className="bg-white/15 border-2 border-white/30 rounded-2xl px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-5 flex items-center gap-4 sm:gap-6 md:gap-12 backdrop-blur-sm shadow-xl">
										<div className="text-center">
											<div className="text-white font-bold text-lg sm:text-xl md:text-2xl font-mono">
												1M+
											</div>
