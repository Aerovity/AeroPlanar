...
const testimonials = [
	...
	},
	{
		...
		handle: "@bentossell",
		verified: true,
		quote: "well, an actually enjoyable way to organise my whole in and out of my business, plus highlighted a bunch of things I need to cancel",
	},
	{
	...
	},
	{
		...
		handle: "@rauchg",
		verified: true,
		quote: "amazing to see @aeroplanar AI-powered 3D modeling features built on cutting-edge tech - aeroplanar is becoming one of the best 3D modeling solutions",
	},
	{
		name: "Steven Tey",
		avatarUrl:
		...
		handle: "@steventey",
		verified: true,
		quote: `Just found my new favorite 3D modeling project → http://aeroplanar.io
	...
	},
	{
		...
		handle: "@peer_rich",
		verified: true,
		quote: "the best thing i couldve done as a designer is build something that helps other creators. so proud 🖤 @aeroplanar",
	},
];
...
export function Testimonials() {
	return (
		<div className="relative pb-22">
			<h3 className="text-4xl mb-8 font-medium text-foreground">
				What people say
			</h3>
			<InfiniteMovingCards
				items={testimonials}
