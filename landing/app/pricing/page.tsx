	...
	const handleContactUs = () => {
		...
		setTimeout(() => {
			window.location.href =
				"mailto:contact@aeroplanar.com?subject=Company Plan Inquiry";
		}, 1000);
	};
				...
				<div className="pt-20 pb-12 space-y-6">
					<div className="text-center space-y-4">
						...
						<p className="text-xl text-gray-300 max-w-2xl mx-auto">
							Start creating amazing 3D models with our AI-powered
							studio. Choose the plan that fits your needs.
						</p>
					</div>
				</div>
					...
					<div className="text-center space-y-6">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
							<div className="p-6 rounded-lg bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-800/50">
								<div className="text-[#c3b383] text-3xl font-bold mb-2">
									40
								</div>
								...
								<div className="text-gray-400 text-sm">
									Each AI 3D model generation costs 40 credits
								</div>
							</div>
							<div className="p-6 rounded-lg bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-800/50">
								<div className="text-[#c3b383] text-3xl font-bold mb-2">
								...
								<div className="text-gray-400 text-sm">
									Get 100 credits for just $4 - that's 2.5
									generations!
								</div>
							</div>
							<div className="p-6 rounded-lg bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-800/50">
								...
								<div className="text-gray-400 text-sm">
									Credits never expire - use them whenever you
									want
								</div>
							</div>
						</div>
					...
					<div className="space-y-6">
						<div className="p-6 rounded-lg bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-800/50">
							...
							<p className="text-gray-300 text-sm">
								Free users get 1 generation per month and basic
								features. Pro users get unlimited generations,
								scene downloads, and advanced features.
							</p>
						</div>
						<div className="p-6 rounded-lg bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-800/50">
							<h3 className="text-white font-semibold mb-2">
							...
							<p className="text-gray-300 text-sm">
								No! Credits never expire. Buy once and use them
						...
						<div className="p-6 rounded-lg bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-800/50">
							...
							<p className="text-gray-300 text-sm">
								You can purchase more credits anytime. Free
								users automatically become Pro users with their
						...
						<div className="p-6 rounded-lg bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-800/50">
							...
							<p className="text-gray-300 text-sm">
								...
								you're not happy with your purchase, we'll
								refund your credits.
							</p>
						</div>
					</div>
